...
#Try different percentages of train test split------------------------------------------------------------
#split data to train (85%) and test set(15%)
#x_train, x_test, y_train, y_test = train_test_split(X,train_df_new['A16'], test_size=0.15,random_state = 5)
...
#split data to train (70%) and test set(30%)
#x_train, x_test, y_train, y_test = train_test_split(X,train_df_new['A16'], test_size=0.3,random_state = 5)

#split data to train (60%) and test set(40%)
#x_train, x_test, y_train, y_test = train_test_split(X,train_df_new['A16'], test_size=0.4,random_state = 5)
